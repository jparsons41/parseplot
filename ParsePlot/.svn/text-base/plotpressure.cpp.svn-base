...
PlotPressure::PlotPressure(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::PlotPressure)
{
    ui->setupUi(this);
...
void PlotPressure::plot(QString fpath, QVector<double> dX, QVector <double> dData[],QString SensorSelected)
{
    QString temp;
    QString line;
    fPath = fpath;
    ui->plot->yAxis->setLabel("Pascals");
...
void PlotPressure::contextMenuRequest(QPoint pos)
{
...
void PlotPressure::x60SecondZoom()
{
    ui->plot->xAxis->setRange(ui->plot->xAxis->pixelToCoord(xPosPressure),60,Qt::AlignCenter);
    ui->plot->replot();
}

void PlotPressure::x30SecondZoom()
{
    ui->plot->xAxis->setRange(ui->plot->xAxis->pixelToCoord(xPosPressure),30,Qt::AlignCenter);
    ui->plot->replot();
}

void PlotPressure::x10SecondZoom()
{
    ui->plot->xAxis->setRange(ui->plot->xAxis->pixelToCoord(xPosPressure),10,Qt::AlignCenter);
    ui->plot->replot();
}

void PlotPressure::x5SecondZoom()
{
    ui->plot->xAxis->setRange(ui->plot->xAxis->pixelToCoord(xPosPressure),5,Qt::AlignCenter);
    ui->plot->replot();
}

void PlotPressure::x1SecondZoom()
{
    ui->plot->xAxis->setRange(ui->plot->xAxis->pixelToCoord(xPosPressure),1,Qt::AlignCenter);
    ui->plot->replot();


}

void PlotPressure::x1mSecondZoom()
{
    ui->plot->xAxis->setRange(ui->plot->xAxis->pixelToCoord(xPosPressure),0.1,Qt::AlignCenter);
    ui->plot->replot();
}

void PlotPressure::addChannel1()
{
...
void PlotPressure::removeChannel1()
{
...
void PlotPressure::removeChannel2()
{
...
//void PlotPressure::removeChannel3()
//{
...
//void PlotPressure::removeChannel4()
//{
...
//void PlotPressure::removeChannel5()
//{
...
//void PlotPressure::removeChannel6()
//{
...
void PlotPressure::removeAllBut1()
{
    ui->plot->graph(1)->setVisible(false);
//    ui->plot->graph(2)->setVisible(false);
//    ui->plot->graph(3)->setVisible(false);
...
void PlotPressure::removeAllBut2()
{
    ui->plot->graph(0)->setVisible(false);
//    ui->plot->graph(2)->setVisible(false);
//    ui->plot->graph(3)->setVisible(false);
...
//void PlotPressure::removeAllBut3()
//{
//    ui->plot->graph(1)->setVisible(false);
//    ui->plot->graph(0)->setVisible(false);
//    ui->plot->graph(3)->setVisible(false);
...
//void PlotPressure::removeAllBut4()
//{
//    ui->plot->graph(1)->setVisible(false);
//    ui->plot->graph(2)->setVisible(false);
//    ui->plot->graph(0)->setVisible(false);
...
//void PlotPressure::removeAllBut5()
//{
//    ui->plot->graph(1)->setVisible(false);
//    ui->plot->graph(2)->setVisible(false);
//    ui->plot->graph(3)->setVisible(false);
...
//void PlotPressure::removeAllBut6()
//{
//    ui->plot->graph(1)->setVisible(false);
//    ui->plot->graph(2)->setVisible(false);
//    ui->plot->graph(3)->setVisible(false);
...
void PlotPressure::on_scaleOnlyY_pressed()
{
    ui->plot->axisRect()->setRangeZoom(Qt::Vertical);
}

void PlotPressure::on_scaleBoth_pressed()
{
    ui->plot->axisRect()->setRangeZoom(Qt::Horizontal | Qt::Vertical);
}

void PlotPressure::on_scaleOnlyX_pressed()
{
    ui->plot->axisRect()->setRangeZoom(Qt::Horizontal);
}

void PlotPressure::on_savPDF_clicked()
{
    QFile pdfFile;
...
void PlotPressure::on_printButton_clicked()
{
    QPrinter p;
